...
class TwitterSentimentProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self._read_tsv(os.path.join(data_dir, "train_text_labels.txt")), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self._read_tsv(os.path.join(data_dir, "dev_text_labels.txt")), "dev")
...
glue_processors = {
    ...
    "rte": RteProcessor,
    "wnli": WnliProcessor,
    "twitter_sentiment": TwitterSentimentProcessor
}
